  ...
  return (
    <main className="min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <section className="text-center py-12 md:py-20">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-fuchsia-500 via-purple-500 to-cyan-500 text-transparent bg-clip-text animate-fade-in">
          Discover amazing creations
        </h1>
        <p className="mt-4 text-base md:text-lg text-gray-400 animate-fade-in px-4">
