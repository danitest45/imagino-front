        ...
        <div className="flex items-center gap-3">
          <div className="relative hidden md:block group">
            ...
            <div
              id="beta-tooltip"
              role="status"
              className="pointer-events-none absolute left-1/2 top-full z-50 mt-2 w-80 -translate-x-1/2 rounded-2xl border border-white/10 bg-gray-950/95 px-4 py-3 text-xs text-gray-100 opacity-0 shadow-lg shadow-purple-500/20 transition-opacity duration-200 group-hover:opacity-100 group-focus-within:opacity-100"
            >
              ...
              <p className="mt-1 text-gray-300">
                ...
                <a href="mailto:support@imaginoai-app.com" className="font-semibold text-fuchsia-200 hover:text-fuchsia-100">
                  support@imaginoai-app.com
                </a>
                .
              </p>
            </div>
